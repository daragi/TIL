...
```text
.
├── day01                  # 1일차 통계 기초 & 데이터 다루기: 표본/모집단, 기술/추론 통계
├── day02/                 # 2일차 : Google Colab 알아보기 ~ 실전! 데이터 실습 (1)
├── day03/                 # 3일차 : 데이터를 선택하는 방법 ~ 실전! 데이터 실습 (3)
├── day04/                 # 4일차 : Pandas로 간단 시각화 ~ 결측치 처리 (실전! 데이터 실습 (5) - [1],[2] 포함)
├── day05/                 # 5일차 : 이상치 처리 ~ 데이터 요약하기 (실전! 데이터 실습 (6) - [1] 포함)
└── data/                  # dataset
```
---
## 📚 상세 커리큘럼
